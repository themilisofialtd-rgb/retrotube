...
== Changelog ==
= 1.9.1 = 2025-07-18
* Fixed: Fix html validation false positive when scripts tags contain ampersand (&) characters

= 1.9.0 = 2025-07-04
* Added: You now can see the errors in the options page if you have added invalid html code in the advertising options
* Fixed: Fix error that could prevent the options page to load properly
...
* Fixed: Fix PHP error when calling round function

= 1.7.6 = 2024-07-18
* Fixed: Fix missing bootstrap modal that prevented theme tools to work correctly

= 1.7.5 = 2024-07-12
* Fixed: Iframes ads are now displayed correctly inside the video player
* Fixed: Fix PHP 8.x Warning Deprecated Optional parameter declared before Required parameter in wpst_add_widget function

= 1.7.4 = 2024-05-13
* Fixed: Fix display of paywall badge when WPS Paywall plugin in installed
* Fixed: Fix numbers displayed on top of thumbs in the carousel

= 1.7.3 = 2024-05-03
* Added: Add compatibility for new WPS Paywall plugin
* Fixed: Fix PHP 8.x Warning Deprecated Optional parameter declared before Required parameter
...
* Updated: Either only one video from the Retrotube video informations box. The priority follows the same order as the video informations options appear in the video post edit page
...
= 1.5.2 = 2021-05-04
* Fixed: Fix 16/9 ratio option that could prevent thumbnails to be visible
...
= 1.4.5 = 2020-10-22
* Updated: Bxslider v4.2.12 to v4.2.15
...
= 1.4.2 = 2020-08-11
* Updated: Update VideoJS from v7.4.1 to v7.8.4
* Updated: Update videojs-quality-selector 1.1.2 to 1.2.4
...
* Fixed: Fix bxSlider JS error when activating the Carousel feature without adding videos to it
...
= 1.2.7 = 2019-04-26
* Fixed: Fix bxSlider click event issue on Chrome
...
= 1.2.4 = 2019-01-09
* Added: Add 4k resolution field in Video Information metabox
...
* Updated: Replace get_stylesheet_directory_uri() function by get_template_directory_uri() for child theme compatibility
...
* Updated: Text for SEO option moved to homepage only to improve SEO
* Fixed: Minor bugs
